...
func TestDetectDogNameFromPath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			path:     filepath.FromSlash("/Users/user/gt/deacon/dogs/alpha"),
			wantName: "alpha",
			wantOK:   true,
		},
		{
			name:     "dog rig worktree",
			path:     filepath.FromSlash("/Users/user/gt/deacon/dogs/alpha/gastown"),
			wantName: "alpha",
			wantOK:   true,
		},
		{
			name:     "deep path in dog worktree",
			path:     filepath.FromSlash("/Users/user/gt/deacon/dogs/bravo/beads/internal/cmd"),
			wantName: "bravo",
			wantOK:   true,
		},
		{
			name:     "hyphenated dog name",
			path:     filepath.FromSlash("/Users/user/gt/deacon/dogs/my-dog/gastown"),
			wantName: "my-dog",
			wantOK:   true,
		},
		{
			name:     "numeric dog name",
			path:     filepath.FromSlash("/Users/user/gt/deacon/dogs/dog123/beads"),
			wantName: "dog123",
			wantOK:   true,
		},
		{
			name:     "not a dog path - polecat",
			path:     filepath.FromSlash("/Users/user/gt/gastown/polecats/fixer/internal"),
			wantName: "",
			wantOK:   false,
		},
		{
			name:     "not a dog path - crew",
			path:     filepath.FromSlash("/Users/user/gt/gastown/crew/george/internal"),
			wantName: "",
			wantOK:   false,
		},
		{
			name:     "deacon but not dogs directory",
			path:     filepath.FromSlash("/Users/user/gt/deacon/boot"),
			wantName: "",
			wantOK:   false,
		},
		{
			name:     "dogs without deacon parent",
			path:     filepath.FromSlash("/Users/user/gt/some/dogs/alpha"),
			wantName: "",
			wantOK:   false,
		},
		{
